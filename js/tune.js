/* PAINEL TEMPORÁRIO DE AJUSTE DA LUZ DO NOME (18/09/2026).
   ...
   Voltou em 18/09 (segunda rodada de ajuste) com os valores TRAVADOS da
   primeira como padrão — o botão PADRÃO devolve o que está no ar. */
(function () {
  'use strict';
  ...
  var GROUPS = [
    ['LETRA', [
      ['font',  'Tamanho da letra',    5, 14, .1, 6.6, 'vw'],
      ['wdth',  'Largura da letra',    100, 125, 1, 109, ''],
      ['ink',   'Clareza da letra',    0, 60, 1, 0, '%']
    ]],
    ['LUZ', [
      ['light',   'Brilho geral',      0, 1, .01, 1, ''],
      ['field',   'Tamanho do campo',  100, 900, 5, 205, 'px'],
      ['stretch', 'Esticamento',       1, 5, .05, 4, ''],
      ['y',       'Altura da luz',     -150, 150, 1, 2, 'px'],
      ['hue',     'Matiz',             -180, 180, 1, -3, 'deg'],
      ['sat',     'Saturação',         0, 2.5, .05, 1.35, '']
    ]],
    ['RAIOS', [
      ['reach', 'Alcance dos raios',   5, 80, 1, 36, '%'],
      ['blur',  'Dispersão (blur)',    0, 10, .1, 1.8, 'px'],
      ['fine',  'Raios finos',         0, 1.5, .05, 1.2, ''],
      ['wide',  'Raios largos',        0, 1.5, .05, .8, ''],
      ['long',  'Raios longos',        0, 1.5, .05, 1, ''],
      ['spin',  'Velocidade do giro',  .1, 8, .1, 4.9, '']
    ]],
    ['NÚCLEO', [
      ['core-size',    'Tamanho do núcleo',   .3, 2.5, .05, 1.15, ''],
      ['core-stretch', 'Largura do núcleo',   1, 3, .05, 1, ''],
      ['core-light',   'Brilho do núcleo',    0, 1.5, .05, 1.5, ''],
      ['core-blur',    'Suavidade do núcleo', 0, 30, .5, 4.5, 'px']
    ]],
    ['CLARÃO', [
      ['flash', 'Força do clarão', 1, 6, .1, 5, '']
    ]]
  ];
